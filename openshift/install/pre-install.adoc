...
.*1. 所有节点配置 DNS*
----
# for i in master infra node1 nfs ; do ssh $i.example.com 'nmcli connection modify eth0 ipv4.dns 192.168.5.106' ; done
----

[source, text]
.*2. 测试 DNS*
----
# for i in master infra node1 nfs ; do ssh $i.example.com 'dig master.example.com @192.168.5.106 +short' ; done
# for i in master infra node1 nfs ; do ssh $i.example.com 'dig infra.example.com @192.168.5.106 +short' ; done
# for i in master infra node1 nfs ; do ssh $i.example.com 'dig nfs.example.com @192.168.5.106 +short' ; done
# for i in master infra node1 nfs ; do ssh $i.example.com 'dig node1.example.com @192.168.5.106 +short' ; done
# for i in master infra node1 nfs ; do ssh $i.example.com 'dig registry.example.com @192.168.5.106 +short' ; done

# for i in master infra node1 nfs ; do ssh $i.example.com 'dig test.apps.example.com @192.168.5.106 +short' ; done
# for i in master infra node1 nfs ; do ssh $i.example.com 'dig xyz.apps.example.com @192.168.5.106 +short' ; done
----
