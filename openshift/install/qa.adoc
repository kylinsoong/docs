...
.*问题分析: describe DC*
----
# oc describe deploymentconfigs/docker-registry
...
Pod Template:
  ...
  Containers:
   registry:
    Image:	registry.example.com/openshift3/ose-docker-registry:v3.9.30
    Port:	5000/TCP
----

NOTE: Check the Image is really exist and the Port are correct.
